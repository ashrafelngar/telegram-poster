...
# الرسالة الأولى (تخدمات السوشيال ميديا - النشر كل 1 ساعة)
MESSAGE_1 = (
    ...
    "<b>💙 قفل أو استرجاع حسابات فيسبوك المسروقة</b>\n\n"
    "🎁 شحن عملات تيك توك\n"
    "⭐️ نجوم فيسبوك\n"
    "🌹 اشتراك Gemini Pro\n"
    "💛 تفعيل CapCut Pro\n"
    "🔦 تفعيل Canva Pro (سنه ب35ج)\n"
    "🤷‍♂️ اشتراك Perplexity AI\n"
    "❤️ نشر أخبار في جرائد\n"
    "❤️‍🔥 خدمات تانية كتير...\n\n"
    "👑 مش لاقي اللي محتاجه؟ اسأل عليه وهظبطهولك\n"
    "<b>📲 كاش:</b> 01102394162"
)

# الرسالة الثانية (كروت باي بيت - النشر كل 3 ساعات)
MESSAGE_2 = (
    "<b>موجود كروت باي بيت Bybit فريش 🔥</b>\n\n"
    "متوفر فيزا 30 جنيه 💳\n"
    "متوفر مستر 40 جنيه 💳\n\n"
    "الفيزا بتطلع ليك فريش بدقيقة 🧨\n"
